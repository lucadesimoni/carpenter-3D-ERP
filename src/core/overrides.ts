...
export function emptyOverrides(): Overrides {
  return { parts: {}, copies: [], stepNames: {} };
}

export function hasOverrides(o: Overrides): boolean {
  return Object.keys(o.parts).length > 0 || o.copies.length > 0 || Object.keys(o.stepNames).length > 0;
}
...
export function applyOverrides(assembly: Assembly, o: Overrides): Assembly {
